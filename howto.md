...
![+](res/select-create-group.png "Add selected device to a group") ![Show Groups](res/show-group.png "Show Groups") ![Create Group](res/create-group.png "Create and name a group")  
